...
[^2]: Este valor se define por la configuración propia de los compilador para valores del tipo `bool` (Ver: [stdbool.h](https://man7.org/linux/man-pages/man0/stdbool.h.0p.html) y [basic types in C](https://en.cppreference.com/w/c/types)).

...
`PARAM_MODO_ESTIMULACION` (`AN`) es el encargado de gestionar el modo de funcionamiento de cada canal, las opciones configurables son `0` para modo simétrico y `1` para modo asimétrico.
